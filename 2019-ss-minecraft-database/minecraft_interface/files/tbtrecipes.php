		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					...
					$query = "SELECT I1.Name ID1, I2.Name ID2, I3.Name ID3, I4.Name ID4, I5.Name ID5, I6.Name ID6, I7.Name ID7, I8.Name ID8, I9.Name ID9, O.Name ID10, OAmnt, Shplss FROM crafting_recipe, item I1, item I2, item I3, item I4, item I5, item I6, item I7, item I8, item I9, item O WHERE TBT = 1 AND IID1 = I1.ID AND IID2 = I2.ID AND IID3 = I3.ID AND IID4 = I4.ID AND IID5 = I5.ID AND IID6 = I6.ID AND IID7 = I7.ID AND IID8 = I8.ID AND IID9 = I9.ID AND OID = O.ID ORDER BY O.Name ASC";
