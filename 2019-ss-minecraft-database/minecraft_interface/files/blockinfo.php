	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/blockinfo.php" method="post">
						<b>Block Info</b>
						<p>Block Name:
							<input type="text" name="bname" size="30" value="" />
						</p>
						<p>
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT ID, Name, Lum, BR, Hard, Flam, TE, InventoryFlag, NSlots FROM Block WHERE Name =  '" . $name . "' ORDER BY Name ASC";
							...
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											...
											<td align="left"><b>Luminance</b></td>
											<td align="left"><b>Blast Resistance</b></td>
											<td align="left"><b>Hardness</b></td>
											<td align="left"><b>Is Flammable</b></td>
											<td align="left"><b>Is Tile Entity</b></td>
											<td align="left"><b>Is Inventory</b></td>
											<td align="left"><b>Number of Slots</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align=align"left">' .
									$row['Name'] . '</td><td align="left">' .
									$row['ID'] . '</td><td align="left">' .
									$row['Lum'] . '</td><td align="left">' .
									$row['BR'] . '</td><td align="left">' .
									$row['Hard'] . '</td><td align="left">' .
									$row['Flam'] . '</td><td align="left">' .
									$row['TE'] . '</td><td align="left">' .
									$row['InventoryFlag'] . '</td><td align="left">' .
									$row['NSlots'] . '</td><td align="left"></tr>';
								}
