		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					...
					$query = "SELECT B.Name Bname, S.Name Sname, E.Level, E.Durat, E.Cause FROM block_effect E, block B, status_effect S WHERE S.ID = E.SEID AND E.BID = B.ID ORDER BY B.Name, S.Name, E.Level, E.Durat ASC";
