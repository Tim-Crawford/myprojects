	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/deleteharvesttool.php" method="post">
						<b>Delete Harvest Tool</b>
						<p>Block ID:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "DELETE FROM harvest_tool WHERE BID = ?";
							...
							if($affected_rows >= 1) {
								echo 'Harvest Tool Deleted Successfully';
