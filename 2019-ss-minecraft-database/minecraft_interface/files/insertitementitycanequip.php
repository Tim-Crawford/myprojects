	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/insertitementitycanequip.php" method="post">
						<b>Insert Item Entity Can Equip</b>
						<p>Item ID:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "INSERT INTO can_equip (IID, EID)
										VALUES (?,?)";
							...
							if($affected_rows == 1) {
								echo 'Item Entity Can Equip Inserted Successfully';
