		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					...
					$query = "SELECT I.Name Iname, S.Name Sname, E.Level, E.Durat, E.Cause FROM item_effect E, item I, status_effect S WHERE S.ID = E.SEID AND E.IID = I.ID ORDER BY I.Name, S.Name, E.Level, E.Durat ASC";
