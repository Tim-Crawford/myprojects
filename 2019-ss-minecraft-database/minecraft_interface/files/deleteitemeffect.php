	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/deleteitemeffect.php" method="post">
						<b>Delete Item Effect</b>
						<p>Item ID:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "DELETE FROM item_effect WHERE IID = ? AND SEID = ? AND Level = ? AND Durat = ?";
							...
							if($affected_rows == 1) {
								echo 'Item Effect Deleted Successfully';
