	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/finditemsforenchant.php" method="post">
						<b>Find Items for Enchant</b>
						<p>Enchantment Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT I.Name FROM enchantment En, item I, enchant E WHERE En.ID = E.EnID AND E.IID = I.ID AND En.Name = '" . $name . "' ORDER BY En.Name ASC";
