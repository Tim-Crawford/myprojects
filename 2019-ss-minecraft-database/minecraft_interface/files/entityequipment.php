	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/entityequipment.php" method="post">
						<b>Entity Equipment</b>
						<p>Entity Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT I.Name FROM entity E, item I, can_equip B WHERE E.ID = B.EID AND B.IID = I.ID AND E.Name = '" . $name . "' ORDER BY I.Name ASC";
							$response = @mysqli_query($dbc, $query);
							
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											<td align="left"><b>Possible Equipment</b></td>
										</tr>';
