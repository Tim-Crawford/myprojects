		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					...
					$query = "SELECT B.Name Bname, I.Name Iname FROM block B, block_drop D, item I WHERE B.ID = D.BID AND D.ST = 1 AND D.IID = I.ID ORDER BY B.Name, I.Name ASC";
