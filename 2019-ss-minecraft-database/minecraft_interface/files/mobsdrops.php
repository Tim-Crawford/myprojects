	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/mobsdrops.php" method="post">
						<b>Mob's Drops</b>
						<p>Mob Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT I.Name, D.Lt, D.MinAmnt, D.MaxAmnt, D.Chance FROM entity E, Item I, entity_drop D WHERE E.Name =  '" . $name . "' AND E.ID = D.EID AND D.IID = I.ID ORDER BY I.Name ASC";
							...
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											...
											<td align="left"><b>Affected by Looting</b></td>
											<td align="left"><b>Min Amount</b></td>
											<td align="left"><b>Max Amount</b></td>
											<td align="left"><b>Chance</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align=align"left">' .
									$row['Name'] . '</td><td align="left">' .
									$row['Lt'] . '</td><td align="left">' .
									$row['MinAmnt'] . '</td><td align="left">' .
									$row['MaxAmnt'] . '</td><td align="left">' .
									$row['Chance'] . '%</td><td align="left"></tr>';
								}
