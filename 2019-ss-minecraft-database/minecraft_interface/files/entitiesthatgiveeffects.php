		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					...
					$query = "SELECT En.Name Ename, S.Name Sname, E.Level, E.Durat, E.Cause FROM entity_effect E, entity En, status_effect S WHERE S.ID = E.SEID AND E.EID = En.ID ORDER BY En.Name, S.Name, E.Level, E.Durat ASC";
