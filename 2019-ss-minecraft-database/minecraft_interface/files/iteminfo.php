	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/iteminfo.php" method="post">
						<b>Item Info</b>
						<p>Item Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT ID, Name, StkSz, Durab, Renew FROM item WHERE Name =  '" . $name . "' ORDER BY Name ASC";
							...
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											...
											<td align="left"><b>Stack Size</b></td>
											<td align="left"><b>Durability</b></td>
											<td align="left"><b>Is Renewable</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align=align"left">' .
									$row['Name'] . '</td><td align="left">' .
									$row['ID'] . '</td><td align="left">' .
									$row['StkSz'] . '</td><td align="left">' .
									$row['Durab'] . '</td><td align="left">' .
									$row['Renew'] . '</td><td align="left"></tr>';
								}
