	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/recipesthatuseitem.php" method="post">
						<b>Recipe that use Item</b>
						<p>Item Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT I1.Name ID1, I2.Name ID2, I3.Name ID3, I4.Name ID4, I5.Name ID5, I6.Name ID6, I7.Name ID7, I8.Name ID8, I9.Name ID9, O.Name ID10, OAmnt, Shplss FROM crafting_recipe, item I1, item I2, item I3, item I4, item I5, item I6, item I7, item I8, item I9, item O WHERE (I1.Name = '" . $name . "' OR I2.Name = '" . $name . "' OR I3.Name = '" . $name . "' OR I4.Name = '" . $name . "' OR I5.Name = '" . $name . "' OR I6.Name = '" . $name . "' OR I7.Name = '" . $name . "' OR I8.Name = '" . $name . "' OR I9.Name = '" . $name . "') AND IID1 = I1.ID AND IID2 = I2.ID AND IID3 = I3.ID AND IID4 = I4.ID AND IID5 = I5.ID AND IID6 = I6.ID AND IID7 = I7.ID AND IID8 = I8.ID AND IID9 = I9.ID AND OID = O.ID ORDER BY O.Name ASC";
							...
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											...
											<td align="left"><b>Is Shapeless</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align="left"><table border="2"><tr><col width="25"><td align="center" height="25">' .
									$row['ID1'] . '</td><td align="center">' .
									$row['ID2'] . '</td><td align="center">' .
									$row['ID3'] . '</td></tr><tr><col width="25"><td align="center" height="25">' .
									$row['ID4'] . '</td><td align="center">' .
									$row['ID5'] . '</td><td align="center">' .
									$row['ID6'] . '</td></tr><tr><col width="25"><td align="center" height="25">' .
									$row['ID7'] . '</td><td align="center">' .
									$row['ID8'] . '</td><td align="center">' .
									$row['ID9'] . '</td></tr></table><td align="left">' .
									$row['ID10'] . '</td><td align="left">' .
									$row['OAmnt'] . '</td><td align="left">' .
									$row['Shplss'] . '</td></tr>';
								}
							...
							$query = "SELECT I.Name ID1, O.Name ID2 FROM smelting_recipe, item I, item O WHERE I.Name = '" . $name . "' AND IID = I.ID AND OID = O.ID ORDER BY O.Name ASC";
							$response = @mysqli_query($dbc, $query);

							if($response){
								echo '<td  valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											<td align="left"><b>Input</b></td>
											<td align="left"><b>Output</b></td>
										</tr>';
							...
							$query = "SELECT IName, I.Name ID2, OName, P.Name ID1, O.Name ID3 FROM brewing_recipe, item P, item I, item O WHERE (P.Name = '" . $name . "' OR I.Name = '" . $name . "') AND PID = P.ID AND InID = I.ID AND OID = O.ID ORDER BY OName, IName, I.Name ASC";
							$response = @mysqli_query($dbc, $query);

							if($response){
								echo '<td  valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											<td align="left"><b>Input Potion</b></td>
											<td align="left"><b>Ingredient</b></td>
											<td align="left"><b>Output Potion</b></td>
											<td align="left"><b>Input Potion Type</b></td>
											<td align="left"><b>Output Potion Type</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align=align"left">' .
									$row['IName'] . '</td><td align="left">' .
									$row['ID2'] . '</td><td align="left">' .
									$row['OName'] . '</td><td align="left">' .
									$row['ID1'] . '</td><td align="left">' .
									$row['ID3'] . '</td><td align="left"></tr>';
								}
