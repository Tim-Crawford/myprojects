	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/blocksdrops.php" method="post">
						<b>Block's Drops</b>
						<p>Block Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT I.Name, D.Ft, D.ST, D.MinAmnt, D.MaxAmnt FROM block B, Item I, block_drop D WHERE B.Name =  '" . $name . "' AND B.ID = D.BID AND D.IID = I.ID ORDER BY I.Name ASC";
							...
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											...
											<td align="left"><b>Affected by Fortune</b></td>
											<td align="left"><b>Affected by Silk Touch</b></td>
											<td align="left"><b>Min Amount</b></td>
											<td align="left"><b>Max Amount</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align=align"left">' .
									$row['Name'] . '</td><td align="left">' .
									$row['Ft'] . '</td><td align="left">' .
									$row['ST'] . '</td><td align="left">' .
									$row['MinAmnt'] . '</td><td align="left">' .
									$row['MaxAmnt'] . '</td><td align="left"></tr>';
								}
