	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/itemtobreedmob.php" method="post">
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT I.Name FROM entity E, item I, breeds_with B WHERE E.ID = B.EID AND B.IID = I.ID AND E.Name = '" . $name . "' ORDER BY I.Name ASC";
							$response = @mysqli_query($dbc, $query);
							
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											<td align="left"><b>Breeding Item</b></td>
										</tr>';
