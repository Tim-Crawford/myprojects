	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/deleteblockeffect.php" method="post">
						<b>Delete Block Effect</b>
						<p>Block ID:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "DELETE FROM block_effect WHERE BID = ? AND SEID = ? AND Level = ? AND Durat = ?";
							...
							if($affected_rows == 1) {
								echo 'Block Effect Deleted Successfully';
