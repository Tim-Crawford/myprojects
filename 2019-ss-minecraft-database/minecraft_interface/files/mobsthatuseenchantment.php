	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/mobsthatuseenchantment.php" method="post">
						<b>Mobs that use Enchantment</b>
						<p>Enchantment Name:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT DISTINCT E.Name FROM enchantment Enc, item I, enchant En, can_equip C, entity E WHERE Enc.ID = En.EnID AND En.IID = I.ID AND I.ID = C.IID AND C.EID = E.ID AND Enc.Name = '" . $name . "' ORDER BY E.Name ASC";
