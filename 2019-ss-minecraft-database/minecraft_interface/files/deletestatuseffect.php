	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/deletestatuseffect.php" method="post">
						<b>Delete Status Effect</b>
						<p>ID:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "DELETE FROM status_effect WHERE ID = ?";
							...
							if($affected_rows == 1) {
								echo 'Status Effect Deleted Successfully';
