	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/insertsmeltingrecipe.php" method="post">
						<b>Insert Smelting Recipe</b>
						<p>Input ID:
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "INSERT INTO smelting_recipe (IID, OID)
										VALUES (?,?)";
