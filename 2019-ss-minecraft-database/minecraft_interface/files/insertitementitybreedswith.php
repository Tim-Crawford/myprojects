	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/insertitementitybreedswith.php" method="post">
						<b>Insert Item Entity Breeds With</b>
						<p>Item ID:
							<input type="text" name="iid" size="30" value="" />
						</p>
						<p>Entity ID:
							<input type="text" name="eid" size="30" value="" />
						</p>
						<p>
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "INSERT INTO breeds_with (IID, EID)
										VALUES (?,?)";
							...
							if($affected_rows == 1) {
								echo 'Item Entity Breeds With Inserted Successfully';
