	...
	<body>
		...
		<table cellpadding="20">
			...
			<tr>
				...
				<td valign="top">
					<form action="http://localhost/minecraft_interface/files/entityinfo.php" method="post">
						<b>Entity Info</b>
						<p>Entity Name:
							<input type="text" name="ename" size="30" value="" />
						</p>
						<p>
					...
					if(isset($_POST['submit'])){
						...
						if(empty($errors)){
							...
							$query = "SELECT ID, Name, LivingFlag, Mount, HP, Lead, Fly, HostileFlag, PassiveFlag, AtkDmg, Tame FROM entity WHERE Name =  '" . $name . "' ORDER BY Name ASC";
							...
							if($response){
								echo '</td><td valign="top"><table align="left" cellspacing="5" cellpadding="8">
										<tr>
											...
											<td align="left"><b>Is Living</b></td>
											<td align="left"><b>Is Mountable</b></td>
											<td align="left"><b>HP</b></td>
											<td align="left"><b>Can be Led</b></td>
											<td align="left"><b>Can Fly</b></td>
											<td align="left"><b>Is Hostile</b></td>
											<td align="left"><b>Is Passive</b></td>
											<td align="left"><b>Attack Damage</b></td>
											<td align="left"><b>Is Tameable</b></td>
										</tr>';
								while($row = mysqli_fetch_array($response)){
									echo '<tr><td align=align"left">' .
									$row['Name'] . '</td><td align="left">' .
									$row['ID'] . '</td><td align="left">' .
									$row['LivingFlag'] . '</td><td align="left">' .
									$row['Mount'] . '</td><td align="left">' .
									$row['HP'] . '</td><td align="left">' .
									$row['Lead'] . '</td><td align="left">' .
									$row['Fly'] . '</td><td align="left">' .
									$row['HostileFlag'] . '</td><td align="left">' .
									$row['PassiveFlag'] . '</td><td align="left">' .
									$row['AtkDmg'] . '</td><td align="left">' .
									$row['Tame'] . '</td><td align="left"></tr>';
								}
